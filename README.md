# Недвижимость (Квартиры/Сделки/Клиенты) — упрощённая версия
...
```
## Вывод
Разработана рабочая система учёта недвижимости с консольным интерфейсом. Реализованы принципы ООП, все объекты сохраняются в SQLite. Код минимален, но полностью соответствует требованиям лабораторной работы.